package br.com.porto.model.bike;

public class Info_Bikes {
    ...
    public Info_Bikes(String marca_bike, int ano_bike, double valor_bike, String utl_bike, String tipo_bike) {
        marca_bike = marca_bike;
        this.ano_bike = ano_bike;
        this.valor_bike = valor_bike;
        this.utl_bike = utl_bike;
